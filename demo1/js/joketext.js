window.onload = function() {
    ...
    var firsturl = "https://route.showapi.com/341-1?maxResult=20&page=1&showapi_appid=31610&showapi_sign=794da37ef6d548bdb3faf07de393bc6d";
    $.ajax({
        type: "get",
        url: firsturl,
        dataType: "json",
    ...
    $(window).scroll(function(event) {    
        ...
        console.log(dsm);
        if (dsm == sm) {
            var myurl = "https://route.showapi.com/341-1?maxResult=20&page=" + (++page) + "&showapi_appid=31610&showapi_sign=794da37ef6d548bdb3faf07de393bc6d";
            $.ajax({
                type: "get",
                url: myurl,
                dataType: "json",
